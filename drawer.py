...
class Frame():
    def __init__(self, screen, screen_w = 0, screen_h = 0):
        ...
        # percentage value
        self.percentage_line1 = 0.1
        self.percentage_line2 = 0.3
        self.percentage_line3 = 0.5
        self.percentage_line4 = 1
    ...
    def init_frame(self):
        ...
        self.label_flasher_status_line1_y = 0 + 160
        ...
        self.label_flasher_status_value_line1_y = 0 + 160
        ...
        self.label_flasher_status_line2_y = 0 + 160
        ...
        self.label_flasher_status_value_line2_y = 0 + 160
        ...
        self.label_flasher_status_line3_y = (self.screen_h/2) + 160
        ...
        self.label_flasher_status_value_line3_y = (self.screen_h/2) + 160
        ...
        self.label_flasher_status_line4_y = (self.screen_h/2) + 160
        ...
        self.label_flasher_status_value_line4_y = (self.screen_h/2) + 160
        ...
        self.label_filename_value_x = 20
        self.label_filename_value_y = (((self.screen_h/2) * 2) + 20) + 30
